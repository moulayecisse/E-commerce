...
class CartController extends AbstractController
{
    ...
    {
        $cart = $cartRepository->findOneBy(['status' => 'active']);
    ...
    #[Route(path: '/stripe/hook', name: 'stripe_hook')]
    ...
    #[Route(path: '/stripe/create/session', name: 'stripe_create_session', methods: ['POST'])]
    ...
    #[Route(path: '/commande/validation', name: 'cart_success')]
    public function cartSuccess()
    {
        return new Response('yoouuuuuupppipiiiiii');
    }

    #[Route(path: '/commande/annulation', name: 'cart_canceled')]
